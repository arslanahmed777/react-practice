                                ...
                                <div className="col-sm-12">
                                    <table className="gridtbl">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">{practiceData?.address?.split(",")[0]}</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td> HJ854398</td>
                                            <td colspan="2">{practiceData?.address?.split(",")[1]}</td>
                                            <td>Not Signed</td>
                                            <td>&nbsp;</td>
                                            <td width="1%">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                            <td colspan="2">{practiceData?.address?.split(",")[2]}</td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="6">
                                                Thyroid issues, anxiety about drs (Appt time: 11:00 AM)
                                                (Arrival time: 10:11 AM)
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table className="gridtbl p-0 m-0 ">
                                        ...
                                        <tr className="border">
                                            ...
                                            <td width="25%">{patientEncounter?.patientVitas?.value[0]?.weight_lbs}</td>
                                        </tr>
                                        <tr className="border">
                                            <td className="border">Temperature</td>
                                            <td>{patientEncounter?.patientVitas?.value[0]?.temperatureFahrenheit}</td>
                                        </tr>
                                        <tr className="border">
                                            <td className="border">Pulse</td>
                                            <td>{patientEncounter?.patientVitas?.value[0]?.pulse}bpm</td>
                                        </tr>
                                        <tr className="border">
                                            <td className="border">O2 Saturation</td>
                                            <td>{patientEncounter?.patientVitas?.value[0]?.oxygenSaturation} %</td>
                                        </tr>
                                        <tr className="border">
                                            <td className="border">Blood pressure</td>
                                            <td> {patientEncounter?.patientVitas?.value[0]?.bpSystolic} mmHg</td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                    ...
                                    <table className="gridtbl p-0 m-0 ">
                                        ...
                                        <tr>
                                            <td>(N95.1) Menopausal and female climacteric states</td>
                                            <td>&nbsp;</td>
                                            <td>08/04/2021</td>
                                            <td>-</td>
                                        </tr>
                                    ...
                                    <table className="gridtbl p-0 m-0 ">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                No socila history (free-text) recorded for this patient
                                            </td>
                                        </tr>
                                        <tr className="border gry-heading">
